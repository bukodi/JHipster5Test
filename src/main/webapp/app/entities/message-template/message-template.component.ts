...
export class MessageTemplateComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.messageTemplateService
            ...
            .subscribe(
                (res: HttpResponse<IMessageTemplate[]>) => this.paginateMessageTemplates(res.body, res.headers),
    ...
    trackId(index: number, item: IMessageTemplate) {
        return item.id;
    }
    ...
    private paginateMessageTemplates(data: IMessageTemplate[], headers: HttpHeaders) {
