...
export class IdentityComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.identityService
            ...
            .subscribe(
                (res: HttpResponse<IIdentity[]>) => this.paginateIdentities(res.body, res.headers),
    ...
    trackId(index: number, item: IIdentity) {
        return item.id;
    }
    ...
    private paginateIdentities(data: IIdentity[], headers: HttpHeaders) {
