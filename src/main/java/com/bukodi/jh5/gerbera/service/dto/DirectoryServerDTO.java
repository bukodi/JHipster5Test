...
/**
 * A DTO for the DirectoryServer entity.
 */
public class DirectoryServerDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DirectoryServerDTO directoryServerDTO = (DirectoryServerDTO) o;
        if (directoryServerDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), directoryServerDTO.getId());
    }
