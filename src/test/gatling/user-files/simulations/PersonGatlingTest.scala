...
class PersonGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Person entity")
        ...
        .repeat(2) {
            ...
            .post("/api/people")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "idCard":"SAMPLE_TEXT", "zipCode":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "additionalInfo":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
