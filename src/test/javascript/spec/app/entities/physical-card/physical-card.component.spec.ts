...
import { PhysicalCardComponent } from 'app/entities/physical-card/physical-card.component';
...
describe('Component Tests', () => {
    describe('PhysicalCard Management Component', () => {
        let comp: PhysicalCardComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PhysicalCardComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.physicalCards[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
