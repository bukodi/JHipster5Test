...
import { LogicalCardComponent } from 'app/entities/logical-card/logical-card.component';
...
describe('Component Tests', () => {
    describe('LogicalCard Management Component', () => {
        let comp: LogicalCardComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LogicalCardComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.logicalCards[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
