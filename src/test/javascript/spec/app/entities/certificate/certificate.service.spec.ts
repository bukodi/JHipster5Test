    ...
    describe('Certificate Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/certificates';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Certificate', () => {
                service.create(new Certificate(null)).subscribe(received => {
            ...
            it('should update a Certificate', () => {
                service.update(new Certificate(123)).subscribe(received => {
