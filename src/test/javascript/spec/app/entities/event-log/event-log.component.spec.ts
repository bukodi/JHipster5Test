...
import { EventLogComponent } from 'app/entities/event-log/event-log.component';
...
describe('Component Tests', () => {
    describe('EventLog Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.eventLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
