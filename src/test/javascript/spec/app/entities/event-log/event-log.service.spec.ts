...
describe('Service Tests', () => {
    describe('EventLog Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EventLogService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/event-logs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EventLog', () => {
                service.create(new EventLog(null)).subscribe(received => {
            ...
            it('should update a EventLog', () => {
                service.update(new EventLog(123)).subscribe(received => {
