...
import { CertificateTemplateComponent } from 'app/entities/certificate-template/certificate-template.component';
...
describe('Component Tests', () => {
    describe('CertificateTemplate Management Component', () => {
        let comp: CertificateTemplateComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CertificateTemplateComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new CertificateTemplate(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.certificateTemplates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
