...
import { IdentityProfileComponent } from 'app/entities/identity-profile/identity-profile.component';
...
describe('Component Tests', () => {
    describe('IdentityProfile Management Component', () => {
        let comp: IdentityProfileComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(IdentityProfileComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.identityProfiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
