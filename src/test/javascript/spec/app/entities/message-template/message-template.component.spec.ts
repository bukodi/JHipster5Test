...
import { MessageTemplateComponent } from 'app/entities/message-template/message-template.component';
...
describe('Component Tests', () => {
    describe('MessageTemplate Management Component', () => {
        let comp: MessageTemplateComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MessageTemplateComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.messageTemplates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
