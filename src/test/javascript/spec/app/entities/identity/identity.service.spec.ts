    ...
    describe('Identity Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/identities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Identity', () => {
                service.create(new Identity(null)).subscribe(received => {
            ...
            it('should update a Identity', () => {
                service.update(new Identity(123)).subscribe(received => {
