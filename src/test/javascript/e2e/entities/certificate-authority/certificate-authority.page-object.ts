...
export class CertificateAuthorityComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    title = element.all(by.css('-certificate-authority div h2#page-heading span')).first();
...
export class CertificateAuthorityUpdatePage {
    pageTitle = element(by.id('-certificate-authority-heading'));
